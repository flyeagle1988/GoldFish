...
const COL_DATA_COLUMN_TYPE COL_DATA_COLUMN_TYPE_COLUMN_TYPE_MAX = COL_DATA_COLUMN_TYPE_NUM;
...
class COL_DATA : public ::google::protobuf::Message {
 public:
  ...
  static const COLUMN_TYPE NUM = COL_DATA_COLUMN_TYPE_NUM;
