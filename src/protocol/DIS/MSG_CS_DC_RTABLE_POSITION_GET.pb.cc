...
MSG_CS_DC_RTABLE_POSITION_GET::MSG_CS_DC_RTABLE_POSITION_GET()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:MSG_CS_DC_RTABLE_POSITION_GET)
}
...
MSG_CS_DC_RTABLE_POSITION_GET::MSG_CS_DC_RTABLE_POSITION_GET(const MSG_CS_DC_RTABLE_POSITION_GET& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:MSG_CS_DC_RTABLE_POSITION_GET)
}
...
MSG_CS_DC_RTABLE_POSITION_GET::~MSG_CS_DC_RTABLE_POSITION_GET() {
  // @@protoc_insertion_point(destructor:MSG_CS_DC_RTABLE_POSITION_GET)
  SharedDtor();
}
...
const MSG_CS_DC_RTABLE_POSITION_GET& MSG_CS_DC_RTABLE_POSITION_GET::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_MSG_5fCS_5fDC_5fRTABLE_5fPOSITION_5fGET_2eproto();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:MSG_CS_DC_RTABLE_POSITION_GET)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:MSG_CS_DC_RTABLE_POSITION_GET)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:MSG_CS_DC_RTABLE_POSITION_GET)
  return false;
#undef DO_
}
...
void MSG_CS_DC_RTABLE_POSITION_GET::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:MSG_CS_DC_RTABLE_POSITION_GET)
  // required uint32 dbID = 1;
  if (has_dbid()) {
  ...
  // @@protoc_insertion_point(serialize_end:MSG_CS_DC_RTABLE_POSITION_GET)
}

::google::protobuf::uint8* MSG_CS_DC_RTABLE_POSITION_GET::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:MSG_CS_DC_RTABLE_POSITION_GET)
  // required uint32 dbID = 1;
  if (has_dbid()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:MSG_CS_DC_RTABLE_POSITION_GET)
  return target;
}
...
MSG_DC_CS_RTABLE_POSITION_GET_ACK::MSG_DC_CS_RTABLE_POSITION_GET_ACK()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:MSG_DC_CS_RTABLE_POSITION_GET_ACK)
}
...
MSG_DC_CS_RTABLE_POSITION_GET_ACK::MSG_DC_CS_RTABLE_POSITION_GET_ACK(const MSG_DC_CS_RTABLE_POSITION_GET_ACK& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:MSG_DC_CS_RTABLE_POSITION_GET_ACK)
}
...
MSG_DC_CS_RTABLE_POSITION_GET_ACK::~MSG_DC_CS_RTABLE_POSITION_GET_ACK() {
  // @@protoc_insertion_point(destructor:MSG_DC_CS_RTABLE_POSITION_GET_ACK)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:MSG_DC_CS_RTABLE_POSITION_GET_ACK)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:MSG_DC_CS_RTABLE_POSITION_GET_ACK)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:MSG_DC_CS_RTABLE_POSITION_GET_ACK)
  return false;
#undef DO_
}
...
void MSG_DC_CS_RTABLE_POSITION_GET_ACK::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:MSG_DC_CS_RTABLE_POSITION_GET_ACK)
  // optional string csIP = 1;
  if (has_csip()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->csip().data(), this->csip().length(),
  ...
  // @@protoc_insertion_point(serialize_end:MSG_DC_CS_RTABLE_POSITION_GET_ACK)
}

::google::protobuf::uint8* MSG_DC_CS_RTABLE_POSITION_GET_ACK::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:MSG_DC_CS_RTABLE_POSITION_GET_ACK)
  // optional string csIP = 1;
  if (has_csip()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      this->csip().data(), this->csip().length(),
  ...
  // @@protoc_insertion_point(serialize_to_array_end:MSG_DC_CS_RTABLE_POSITION_GET_ACK)
  return target;
}
