  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(18)) goto parse_dbid;
        break;
      }
        ...
        if (tag == 18) {
         parse_dbid:
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->add_dbid()));
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            this->dbid(this->dbid_size() - 1).data(),
            this->dbid(this->dbid_size() - 1).length(),
            ::google::protobuf::internal::WireFormat::PARSE,
            "dbid");
        } else {
          goto handle_unusual;
...
void GROUP_DB_INFO::SerializeWithCachedSizes(
  ...
  ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
    this->dbid(i).data(), this->dbid(i).length(),
    ::google::protobuf::internal::WireFormat::SERIALIZE,
    "dbid");
...
::google::protobuf::uint8* GROUP_DB_INFO::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->dbid_size(); i++) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      "dbid");
    target = ::google::protobuf::internal::WireFormatLite::
      WriteStringToArray(2, this->dbid(i), target);
  }
