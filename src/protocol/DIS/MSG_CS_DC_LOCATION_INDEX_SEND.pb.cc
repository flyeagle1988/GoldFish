...
MSG_CS_DC_LOCATION_INDEX_SEND::MSG_CS_DC_LOCATION_INDEX_SEND()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:MSG_CS_DC_LOCATION_INDEX_SEND)
}
...
MSG_CS_DC_LOCATION_INDEX_SEND::MSG_CS_DC_LOCATION_INDEX_SEND(const MSG_CS_DC_LOCATION_INDEX_SEND& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:MSG_CS_DC_LOCATION_INDEX_SEND)
}
...
MSG_CS_DC_LOCATION_INDEX_SEND::~MSG_CS_DC_LOCATION_INDEX_SEND() {
  // @@protoc_insertion_point(destructor:MSG_CS_DC_LOCATION_INDEX_SEND)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:MSG_CS_DC_LOCATION_INDEX_SEND)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:MSG_CS_DC_LOCATION_INDEX_SEND)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:MSG_CS_DC_LOCATION_INDEX_SEND)
  return false;
#undef DO_
}
...
void MSG_CS_DC_LOCATION_INDEX_SEND::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:MSG_CS_DC_LOCATION_INDEX_SEND)
  // required uint32 dbID = 1;
  if (has_dbid()) {
  ...
  // @@protoc_insertion_point(serialize_end:MSG_CS_DC_LOCATION_INDEX_SEND)
}

::google::protobuf::uint8* MSG_CS_DC_LOCATION_INDEX_SEND::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:MSG_CS_DC_LOCATION_INDEX_SEND)
  // required uint32 dbID = 1;
  if (has_dbid()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:MSG_CS_DC_LOCATION_INDEX_SEND)
  return target;
}
...
MSG_DC_CS_LOCATION_INDEX_SEND_ACK::MSG_DC_CS_LOCATION_INDEX_SEND_ACK()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:MSG_DC_CS_LOCATION_INDEX_SEND_ACK)
}
...
MSG_DC_CS_LOCATION_INDEX_SEND_ACK::MSG_DC_CS_LOCATION_INDEX_SEND_ACK(const MSG_DC_CS_LOCATION_INDEX_SEND_ACK& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:MSG_DC_CS_LOCATION_INDEX_SEND_ACK)
}
...
MSG_DC_CS_LOCATION_INDEX_SEND_ACK::~MSG_DC_CS_LOCATION_INDEX_SEND_ACK() {
  // @@protoc_insertion_point(destructor:MSG_DC_CS_LOCATION_INDEX_SEND_ACK)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:MSG_DC_CS_LOCATION_INDEX_SEND_ACK)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:MSG_DC_CS_LOCATION_INDEX_SEND_ACK)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:MSG_DC_CS_LOCATION_INDEX_SEND_ACK)
  return false;
#undef DO_
}
...
void MSG_DC_CS_LOCATION_INDEX_SEND_ACK::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:MSG_DC_CS_LOCATION_INDEX_SEND_ACK)
  // required int32 statusCode = 1;
  if (has_statuscode()) {
  ...
  // @@protoc_insertion_point(serialize_end:MSG_DC_CS_LOCATION_INDEX_SEND_ACK)
}

::google::protobuf::uint8* MSG_DC_CS_LOCATION_INDEX_SEND_ACK::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:MSG_DC_CS_LOCATION_INDEX_SEND_ACK)
  // required int32 statusCode = 1;
  if (has_statuscode()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:MSG_DC_CS_LOCATION_INDEX_SEND_ACK)
  return target;
}
